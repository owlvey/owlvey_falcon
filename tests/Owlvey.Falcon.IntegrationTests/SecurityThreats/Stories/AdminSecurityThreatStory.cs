...
namespace Owlvey.Falcon.IntegrationTests.SecurityThreats.Stories
{
    ...
    public class AdminSecurityThreatStory : IntegrationTestBase, IDisposable, IBaseTest
    {
        private IDisposable _scenario;
        private IContainer _container;

        public AdminSecurityThreatStory()
        {
        ...
        {
            this._scenario = this._container.GetInstance<AdminCanCreateSecurityThreatScenario>();
