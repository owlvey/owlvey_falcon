...
{
    public class AdminCanDeleteJourneyScenario : DefaultScenarioBase, IDisposable
    {        
        public AdminCanDeleteJourneyScenario(HttpClient client): base(client)
        {            
        }
