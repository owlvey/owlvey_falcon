...
{
    public class AdminCanRemoveAnMemberToSquadScenario : AuthenticatedScenario, IDisposable
    {        
        public AdminCanRemoveAnMemberToSquadScenario(HttpClient client): base(client)
        {
