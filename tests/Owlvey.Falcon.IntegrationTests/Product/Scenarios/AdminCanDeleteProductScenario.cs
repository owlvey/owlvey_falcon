...
{
    public class AdminCanDeleteProductScenario : IDisposable
    {
        ...
        public void when_send_request()
        {
            ...
            var responsePost = _client.PostAsync($"/customers/{KeyConstants.CustomerId}/Products", jsonContent).Result;
