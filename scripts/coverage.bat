...
coverlet "./../tests/Owlvey.Falcon.UnitTests/bin/Debug/netcoreapp2.2/Owlvey.Falcon.UnitTests.dll" --target "dotnet" --targetargs "test ./../tests/Owlvey.Falcon.UnitTests/Owlvey.Falcon.UnitTests.csproj --no-build" --format opencover --output "./../tests/Owlvey.Falcon.UnitTests/BuildReports/"
...
start "" ./../tests/Owlvey.Falcon.UnitTests/BuildReports/report/index.htm 