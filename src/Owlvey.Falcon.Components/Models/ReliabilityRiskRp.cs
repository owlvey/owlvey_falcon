...
{
    public class ReliabilityRiskRp
    {
    ...
    public class ReliabilityRiskGetRp : ReliabilityRiskRp
    {
        public int Id { get; set; }
        public string Source { get; set; }
        public int SourceId { get; set; }
    }
    public class ReliabilityRiskPostRp : ReliabilityRiskRp
    {
        public int SourceId { get; set; }    
    }
    public class ReliabilityRiskPutRp : ReliabilityRiskRp
    {
        public int Id { get; set; }
    }
}
