...
=======
        public async Task<IActionResult> GetServices(int id, int productId)
        {
            var model = await this._serviceQueryService.GetServices(productId);
>>>>>>> b3a8cbce03b330f3109f3f97ab5fd034d9b324e2
